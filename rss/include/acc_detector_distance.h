 ...
 * <a href="https://docs.acconeer.com/en/latest/exploration_tool/algo/a121/distance_detection.html">docs.acconeer.com</a>
 * @{
 */

#define ACC_DETECTOR_DISTANCE_RESULT_MAX_NUM_DISTANCES (1U)
 ...
 *
 * This value is used when the threshold method is set to @ref ACC_DETECTOR_DISTANCE_THRESHOLD_METHOD_FIXED
 *
 * @param[out] config The distance detector config
 * @param[in] fixed_threshold_value The fixed threshold value
 */
void acc_detector_distance_config_fixed_threshold_value_set(acc_detector_distance_config_t *config, float fixed_threshold_value);


/**
 * @brief Get fixed threshold value
 *
 * See @ref acc_detector_distance_config_fixed_threshold_value_set
 *
 * @param[in] config The distance detector config
 * @return The fixed threshold value
 */
float acc_detector_distance_config_fixed_threshold_value_get(const acc_detector_distance_config_t *config);
